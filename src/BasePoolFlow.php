...
/**
 */
abstract class BasePoolFlow implements \Inilim\Parallel\ExecuteInterface, \IteratorAggregate, \Countable
{
    /**
     * @var Flow[]
     */
     ...
     */
    abstract function execAndGetTask(\Closure $callback, mixed ...$args): Task;
